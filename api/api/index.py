...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "https://first-aid-tracker.vercel.app",
        "http://localhost:3000",
        "http://localhost:8001",
        "http://localhost:5173",
        "http://127.0.0.1:3000",
...
# API endpoints (same as main.py, without static routes)
...
# Note: Static files are served directly by Vercel from the /public (or /static) folder, so no FileResponse routes are needed here.
